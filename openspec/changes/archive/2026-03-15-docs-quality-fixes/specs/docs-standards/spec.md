...
Define documentation quality standards, content requirements, and consistency rules for all project markdown files in `docs/`, `docs/verify/`, and root-level documentation.
