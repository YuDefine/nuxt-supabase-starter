...
Source: rules/core/service-url-locality.md
Edit at: $CLADE_HOME
...
> Pitfall：[[pitfall-one-service-url-two-audiences-server-vs-client]]（<consumer-h> 2026-08-26、
...
（<consumer-h>：`/api/health` 的 DB 段 590–660ms → 13–73ms），**NEVER** 只憑「設定改了」宣告修好。
