...
| 2 | `/specify` | PM | `specs/plans/NNN-<slug>/{spec.md,checklists/requirements.md,truth-delta.md}`；新需求永遠開新 package |
...
| 6 | `/system-analysis`（委派 `/api-plan`、`/data-plan`） | RD | plan `plan.md`；只有 PM gate 通過後可進入 |
