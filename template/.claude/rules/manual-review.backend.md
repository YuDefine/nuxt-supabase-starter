...
`[discuss]` items 由 `/spectra-archive` Step 2.5 Walkthrough 觸發；主線 session owner 主動準備 evidence（含 backend grep / query / SSH / curl / migration check 結果）→ 使用者明確 OK / Issue / Skip / Defer。
