...
| Need requirements clarified before code  | `/impeccable shape`   | Shape phase before new-work build；確認走 Shape brief 決策頁 |
| Build a new feature / page               | new-work build        | Direction Gate（concept-seed + serve-question）後描述目標介面；**NEVER** 輸出 `/impeccable craft` |
