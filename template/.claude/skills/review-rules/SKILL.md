...
此 skill **只負責 CRUD**：新增、修改、刪除、列出 `.claude/agents/references/project-review-rules.md` 中的審查規則。
...
1. 讀取 `.claude/agents/references/project-review-rules.md`
2. 確認規則不重複
...
讀取並展示 `.claude/agents/references/project-review-rules.md` 的完整內容。
...
- 規則檔位置固定：`.claude/agents/references/project-review-rules.md`
