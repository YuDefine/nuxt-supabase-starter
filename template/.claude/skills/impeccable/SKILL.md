...
Then ask the user directly to clarify what you cannot infer. Keep the Design Context in `.impeccable.md` only; do not append it to generated projection files.
