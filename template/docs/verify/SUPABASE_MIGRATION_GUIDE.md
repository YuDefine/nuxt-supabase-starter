...
> Self-hosted 模式的開發流程（Migration、RLS、API）與 Cloud 完全相同，僅部署方式不同。

詳細的 Self-hosted 部署流程、備份還原、版本升級、Migration 回滾等，請參考 [SELF_HOSTED_SUPABASE.md](./SELF_HOSTED_SUPABASE.md)。
