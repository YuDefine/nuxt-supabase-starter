---
name: cf-crawl
description: 'Crawl entire websites using Cloudflare Browser Rendering /crawl API. Initiates async crawl jobs, polls for completion, and saves results as markdown files. Use when 要爬整個網站、匯入文件站、抓 knowledge base 內容、或批次擷取 web content 到專案 context。Requires CLOUDFLARE_ACCOUNT_ID and CLOUDFLARE_API_TOKEN environment variables.'
---
